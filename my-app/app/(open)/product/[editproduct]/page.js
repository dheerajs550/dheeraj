...
import Link from 'next/link';
  ...
  function Page({params}) {
        ...
        const unwrappedParams = React.use(params)
             ...
             useEffect(()=>{
                getProductDelail()
             },[unwrappedParams.editproduct])
  
            // this code for  prifill infut fild 
            const getProductDelail = async ()=>{
                let productData = await fetch(`${BASE_URL}/products/${unwrappedParams.editproduct}`)
            ...
            const updateProduct = async()=>{
               let data = await fetch(`${BASE_URL}/products/${unwrappedParams.editproduct}`,{
                method:"PUT",
